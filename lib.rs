...
mod erc20 {
    ...
    pub enum Error {
        ...
        InsufficientBalance,
        /// Return an error if the transfer request exceeds the account allowance.
    ...
    pub struct Erc20 {
        ...
        /// Mapping for an owner and non-owner combination to an account balance.
    ...
    mod tests {
        ...
        fn transfer_from_works() {
            ...
            assert_eq!(contract.balance_of(AccountId::from([0x1; 32])), 100);
            contract.approve(AccountId::from([0x1; 32]), 20).unwrap();
            contract
